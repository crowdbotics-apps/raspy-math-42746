"""
Django settings for raspy_math_42746 project.
...
ROOT_URLCONF = 'raspy_math_42746.urls'
...
WSGI_APPLICATION = 'raspy_math_42746.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "raspy_math_42746 API",
    "DESCRIPTION": "API documentation for raspy_math_42746 App",
    "VERSION": "v1",
}
